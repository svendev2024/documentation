...
.. note::
   - The :guilabel:`Contact` is a person related to the document who only has viewing
...
.. tip::
   An employee must be the owner of a document to be able to see it in **My Profile**.
