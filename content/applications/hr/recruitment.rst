...
.. tip::
   ...
   <recruitment/aplicant-scheduled>` .
...
activities or emails configured for this stage. The recruiter can now :doc:`schedule a second
interview <schedule_interviews>` with the applicant, following the same process as the
first interview.
